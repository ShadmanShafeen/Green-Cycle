        ...
        child: IntrinsicHeight(
          child: Container(
            ...
            child: Padding(
              ...
              child: Row (children: [
                Text("$coinsEarned Coins Earned" , style: TextStyle(fontWeight: FontWeight.w600,color: Theme.of(context).colorScheme.onSurface), textScaler: const TextScaler.linear(0.75),),
